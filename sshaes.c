...
static const struct ssh2_cipher ssh_aes128_ctr = {aes_make_context,
                                                  aes_free_context,
                                                  aes_iv,
                                                  aes128_key,
                                                  aes_ssh2_sdctr,
...
static const struct ssh2_cipher ssh_aes192_ctr = {aes_make_context,
                                                  aes_free_context,
                                                  aes_iv,
                                                  aes192_key,
                                                  aes_ssh2_sdctr,
...
static const struct ssh2_cipher ssh_aes256_ctr = {aes_make_context,
                                                  aes_free_context,
                                                  aes_iv,
                                                  aes256_key,
                                                  aes_ssh2_sdctr,
...
const struct ssh2_ciphers ssh2_aes = {sizeof(aes_list) / sizeof(*aes_list),
                                      aes_list};
