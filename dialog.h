...
typedef void (*handler_fn)(union control *ctrl,
                           void *dlg,
                           void *data,
                           int event);
...
struct controlset *ctrl_settitle(struct controlbox *, char *path, char *title);
...
union control *ctrl_editbox(struct controlset *,
                            char *label,
                            char shortcut,
                            int percentage,
                            intorptr helpctx,
                            ...
                            intorptr context,
                            intorptr context2);
union control *ctrl_combobox(struct controlset *,
                             char *label,
                             char shortcut,
                             int percentage,
                             intorptr helpctx,
 ...
 * is NO_SHORTCUT.
 */
union control *ctrl_radiobuttons(struct controlset *,
                                 char *label,
                                 char shortcut,
                                 int ncolumns,
                                 intorptr helpctx,
                                 ...
                                 intorptr context,
                                 ...);
union control *ctrl_pushbutton(struct controlset *,
                               char *label,
                               char shortcut,
                               intorptr helpctx,
                               handler_fn handler,
                               intorptr context);
union control *ctrl_listbox(struct controlset *,
                            char *label,
                            char shortcut,
                            intorptr helpctx,
                            handler_fn handler,
                            intorptr context);
union control *ctrl_droplist(struct controlset *,
                             char *label,
                             char shortcut,
                             int percentage,
                             intorptr helpctx,
                             handler_fn handler,
                             intorptr context);
union control *ctrl_draglist(struct controlset *,
                             char *label,
                             char shortcut,
                             intorptr helpctx,
                             handler_fn handler,
                             intorptr context);
union control *ctrl_filesel(struct controlset *,
                            char *label,
                            char shortcut,
                            char const *filter,
                            int write,
                            ...
                            handler_fn handler,
                            intorptr context);
union control *ctrl_fontsel(struct controlset *,
                            char *label,
                            char shortcut,
                            intorptr helpctx,
                            handler_fn handler,
...
union control *ctrl_checkbox(struct controlset *,
                             char *label,
                             char shortcut,
                             intorptr helpctx,
                             handler_fn handler,
 ...
 */
void dlg_stdradiobutton_handler(union control *ctrl,
                                void *dlg,
                                void *data,
                                int event);
/*
...
void dlg_stdcheckbox_handler(union control *ctrl,
                             void *dlg,
                             void *data,
                             int event);
/*
 ...
 *    field to 1200.)
 */
void dlg_stdeditbox_handler(union control *ctrl,
                            void *dlg,
                            void *data,
                            int event);
/*
 ...
 */
void dlg_stdfilesel_handler(union control *ctrl,
                            void *dlg,
                            void *data,
                            int event);
/*
 ...
 * pointed to by `data'.
 */
void dlg_stdfontsel_handler(union control *ctrl,
                            void *dlg,
                            void *data,
                            int event);
