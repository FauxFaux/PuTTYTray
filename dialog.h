...
void *ctrl_alloc_with_free(struct controlbox *b,
                           size_t size,
...
union control *ctrl_icon(struct controlset *,
                         intorptr helpctx,
                         intorptr context);
...
char *dlg_editbox_get(union control *ctrl,
                      void *dlg); /* result must be freed by caller */
