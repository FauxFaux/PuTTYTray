...
extern void dbug_enter(const char *func,
                       const char *file,
                       unsigned line,
                       const char **sfunc,
                       const char **sfile,
                       unsigned *slevel,
                       char ***);
extern void dbug_thread_enter(const char *func,
                              const char *file,
                              unsigned line,
                              const char **sfunc,
                              const char **sfile,
...
#define DBUG_EXECUTE(keyword, stmt)                                            \
  do {                                                                         \
    if (dbug_on && dbug_keyword(keyword)) {                                    \
      stmt                                                                     \
    }                                                                          \
  } while (0)
...
#define DBUG_DUMP(keyword, a1, a2)                                             \
  do {                                                                         \
    if (dbug_on) {                                                             \
      dbug_dump(__LINE__, keyword, a1, a2);                                    \
    }                                                                          \
  } while (0)
