...
static void des_encrypt(
    word32 l, word32 r, word32 *output, DESContext *ks, int encrypt);
...
/* Encrypts len bytes from src to dest in CBC modes.  Len must be a multiple
   ...
   encryption. */
static void des_cbc_encrypt(DESContext *ks,
                            unsigned char *iv,
                            unsigned char *dest,
...
/* Decrypts len bytes from src to dest in CBC modes.  Len must be a multiple
   of 8.  iv will be modified at end to a value suitable for continuing
   decryption. */
static void des_cbc_decrypt(DESContext *ks,
                            unsigned char *iv,
                            unsigned char *dest,
                            const unsigned char *src,
                            unsigned int len);
...
static void des_3cbc_encrypt(DESContext *ks1,
                             unsigned char *iv1,
                             DESContext *ks2,
                             unsigned char *iv2,
                             DESContext *ks3,
...
static void des_3cbc_decrypt(DESContext *ks1,
                             unsigned char *iv1,
                             DESContext *ks2,
                             unsigned char *iv2,
                             DESContext *ks3,
...
void des_encrypt_buf(DESContext *ks,
                     unsigned char *out,
