...
static BYTE PrivateKeyWithExponentOfOne[] = {
    ...
    ,
    ...
    0x64, 0xD5, 0xAA, 0xB1, 0xA6, 0x03, 0x18, 0x92, 0x03, 0xAA, 0x31, 0x2E,
    0x48, 0x4B, 0x65, 0x20, 0x99, 0xCD, 0xC6, 0x0C, 0x15, 0x0C, 0xBF, 0x3E,
...
int crypto_startup()
{
  if (CryptAcquireContext(
          &hCryptProv, "Putty", CSP, PROV_RSA_FULL, CRYPT_NEWKEYSET) == 0) {
    if (GetLastError() == NTE_EXISTS) {
      if (CryptAcquireContext(&hCryptProv, "Putty", CSP, PROV_RSA_FULL, 0) ==
          0) {
...
void rsaencrypt(unsigned char *data, int length, struct RSAKey *rsakey)
{
  ...
  pKeybuf =
      ((unsigned char *)pBlob) + sizeof(PUBLICKEYSTRUC) + sizeof(RSAPUBKEY);
