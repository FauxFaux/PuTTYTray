...
static void hmacmd5_do_hmac_ssh(void *handle,
                                unsigned char const *blk,
                                int len,
                                unsigned long seq,
                                unsigned char *hmac)
...
static void hmacmd5_generate(void *handle,
                             unsigned char *blk,
                             int len,
                             unsigned long seq)
{
...
static int hmacmd5_verify(void *handle,
                          unsigned char *blk,
                          int len,
                          unsigned long seq)
{
...
const struct ssh_mac ssh_md5 = {hmacmd5_make_context,
